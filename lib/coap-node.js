...
CoapNode.prototype.registerConfigured  = function (callback) {
    var self = this,
    ...
    _.forEach(serverObjs, function (serverObj, iid) {
        ...
        if (lwm2mServerURI) {
            ...
            serverAttrs = self._getServerAttrs(serverObj);
            self.register(serverInfo.address, serverInfo.port, function (err, rsp) {
                if (err) {
                    chkErr = chkErr || err;
                }            
            });
    ...
    if (chkErr)
        ...
        invokeCbNextTick(null, null, callback);
};
...
// [TODO] serverId
CoapNode.prototype._getServerAttrs = function (serverId) {
    var serverObj = {},
        attrs = {
            lifetime: serverObj.lifetime,
            pmin: serverObj.defaultMinPeriod || this._config.defaultMinPeriod, 
            pmax: serverObj.defaultMaxPeriod || this._config.defaultMaxPeriod
        };
...
CoapNode.prototype._enableReport = function (oid, iid, rid, format, rsp, callback) {
    var self = this,
